...
description: "Guidance for writing agent-consumed documents: skills, AGENTS.md, CLAUDE.md, and referenced docs. Use when improving wording, structure, or context loading without changing a skill's behavior contract; use skill-creator for new capabilities or workflow/resource redesign, and empirical-prompt-tuning for behavioral measurement."
---
